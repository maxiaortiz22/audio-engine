...
typedef enum processor {
    EQUALIZER       = 0x20000, // not used re check this
    FREQUENCY_CUT   = 0x3000,
    LIMITER 		= 0x4000,
    COMPRESSOR 		= 0x5000,
    EXPANDER 		= 0x6000,
    WAV_READER		= 0x70000, // not used re check this
    NOISE_GATE 		= 0x8000,
    SPECTRUM		= 0x9000,
    VUMETER          = 0xA000,
    ...
    NOISE_GENERATOR_OLD  = 0xF000,
    TONE_GENERATOR_OLD   = 0x2000,
    SECOND_TONE_GENERATOR_OLD   = 0x7000,
} Processor;
...
typedef enum spectrum_param {
    ...
    SP_SPECTRUM_MAX_FREQ	= 0x6,
    SP_AVERAGES_MAX_FREQ	= 0x7
} SpectrumParam;
...
typedef enum engine_type {
    ...
    VUMETER_ENGINE = 0x5,
    PLAYBACK_V1_ENGINE = 0x6,
    PLAYBACK_V2_ENGINE = 0x7,
    PLAYBACK_V3_ENGINE = 0x8,
} EngineType;
